<script>
    $(document).ready(function() {
        ...
        getUsers = () => {
            $.ajax({
                url: `${uri}/api/libraries/galleries?${params.toString()}`,
                dataType: "json",
                beforeSend: function() {
                    $('#example1').loading();
                },
        ...
        $('#myform').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: `${uri}/api/libraries/galleries`,
                contentType: '',
                data: formData,
                contentType: false,
                processData: false,
        ...
        $(document).on('click', '#button_detail', function(e) {
            e.preventDefault();
            $('#modal-detail').show();
            let href = `${uri}/api/libraries/galleries/${$(this).attr('data-attr')}`
            $.ajax({
                url: href,
                dataType: "json",
                beforeSend: function() {
        ...
        $('#form_edit').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: `${uri}/api/libraries/galleries/${getDataFromApi.galeryEdit.data.id}?_method=PUT`,
                contentType: '',
                data: formData,
                contentType: false,
                processData: false,
        ...
        $('#modal-create').on('hidden.bs.modal', function() {
            ...
            $('#upload_img').val('').removeClass('is-invalid');
            file = ''
