<section class="h-100 w-100 bg-white" style="box-sizing: border-box">
      <div class="header-4-2 container-xxl mx-auto p-0 position-relative" style="font-family: 'Poppins', sans-serif;">
            <nav class="navbar navbar-expand-lg navbar-light">
                  <button class="navbar-toggler border-1" type="button" data-bs-toggle="modal" data-bs-target="#targetModal-item">
                              ...
                              <div class="modal-content bg-white border-0">
                                    <div class="modal-header border-0" style="padding: 2rem; padding-bottom: 0">
                                          <a class="modal-title" id="targetModalLabel">
                                                <img style="margin-top: 0.5rem" src="{{ secure_asset('Logo-DISPUSIP-Kota-Bandung.png') }}" height="75" width="75" alt="" />
                                          </a>
                                    ...
                                    <div class="modal-body" style="padding: 2rem; padding-top: 0; padding-bottom: 0">
                                          <ul class="navbar-nav responsive me-auto mt-2 mt-lg-0">
                                                ...
                                                <li class="nav-item dropdown @if(Request::segment(1) == 'profile') active @endif">
                                                      <a class="nav-link dropdown-toggle @if(Request::segment(1) == 'profile') active @endif" href="#" data-bs-toggle="dropdown" aria-expanded="false">Profile</a>
                                                ...
                                                <li class="nav-item">
                                                      <a class="nav-link @if(Request::segment(1) == 'information') active @endif" href="{{ route('information') }}">Informasi</a>
                                                </li>
                                                <li class="nav-item">
                                                      <a class="nav-link @if(Request::segment(1) == 'article') active @endif" href="{{ route('article') }}">Berita</a>
                                                </li>
                  ...
                  <div class="collapse navbar-collapse fixed-top border-outline-1" style="padding: 40px; flex: 1; justify-content: space-between; height: 60px; box-shadow:0 0 32px -4px rgba(0,0,0,.15); background-color: #ffffff;" id="navbarTogglerDemo">
                        <div class="container" style="flex: 1;">
                              <a href="#">
                                    <img style="margin-right: 1rem" src="{{ secure_asset('img/Logo-DISPUSIP-Kota-Bandung.png') }}" height="45" width="45" alt="" />
                              </a>
