        ...
        <div class="container border rounded overflow-hidden flex-md-row mt-10 mb-4 shadow h-md-250 position-relative">
            <div class="row">
                <div class="col p-sm-3 p-3 mx-sm-4 mx-3 mt-sm-0 mt-3">
                    <div class="px-3 py-4">
                        <h2>
                            <b>Data Pemustaka Dispusip Kota Bandung</b>
                        </h2>
                        <br />
                        ...
                        <br />
                        <p class="text-center">Total Pemustaka sampai dengan Tahun 2016 : 0</p>
                        <p class="text-center mb-2">Berikut data Tahun 2017 :</p>
                        <br />
                        <div class="px-lg-4">
