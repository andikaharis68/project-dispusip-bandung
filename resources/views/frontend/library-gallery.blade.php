    ...
    <div class="content-2-2 mx-auto position-relative" style="font-family: 'Poppins', sans-serif">
        ...
        <div class="row ml-4 mr-4">
            <div class="img-gallery mb-4" style="height: 300px;">
                <a href="{{ url('library/galery') }}/1" class="h-100">
            ...
            <div class="img-gallery mb-4" style="height: 300px;">
                <a href="{{ url('library/galery') }}/2" class="h-100">
            ...
            <div class="img-gallery mb-4" style="height: 300px;">
                <a href="{{ url('library/galery') }}/3" class="h-100">
        ...
        <div class="row ml-4 mr-4">
            <div class="img-gallery mb-4" style="height: 300px;">
                <a href="{{ url('library/galery') }}/4" class="h-100">
                    <img class="img-gallery-image" style="height: 250px;" src="{{ asset('img/galeri-arsip/1.jpg') }}">
                    <div class="card-body">
                        <h5 class="card-subtitle mb-2 text-muted text-center">Foto Perpustakaan</h5>
                    </div>
            ...
            <div class="img-gallery mb-4" style="height: 300px;">
                <a href="{{ url('library/galery') }}/5" class="h-100">
                    <img class="img-gallery-image" style="height: 250px;" src="{{ asset('img/galeri-arsip/2.jpg') }}">
                    <div class="card-body">
                        <h5 class="card-subtitle mb-2 text-muted text-center">Foto Perpustakaan</h5>
                    </div>
            ...
            <div class="img-gallery mb-4" style="height: 300px;">
                <a href="{{ url('library/galery') }}/6" class="h-100">
                    <img class="img-gallery-image" style="height: 250px;" src="{{ asset('img/galeri-arsip/3.jpg') }}">
                    <div class="card-body">
                        <h5 class="card-subtitle mb-2 text-muted text-center">Foto Perpustakaan</h5>
                    </div>
        ...
        <div class="row ml-4 mr-4">
            <div class="img-gallery mb-4" style="height: 300px;">
                <a href="{{ url('library/galery') }}/7" class="h-100">
                    <img class="img-gallery-image" style="height: 250px;" src="{{ asset('img/galeri-arsip/1.jpg') }}">
                    <div class="card-body">
                        <h5 class="card-subtitle mb-2 text-muted text-center">Foto Perpustakaan</h5>
                    </div>
            ...
            <div class="img-gallery mb-4" style="height: 300px;">
                <a href="{{ url('library/galery') }}/8" class="h-100">
                    <img class="img-gallery-image" style="height: 250px;" src="{{ asset('img/galeri-arsip/2.jpg') }}">
                    <div class="card-body">
                        <h5 class="card-subtitle mb-2 text-muted text-center">Foto Perpustakaan</h5>
                    </div>
            ...
            <div class="img-gallery mb-4" style="height: 300px;">
                <a href="{{ url('library/galery') }}/9" class="h-100">
                    <img class="img-gallery-image" style="height: 250px;" src="{{ asset('img/galeri-arsip/3.jpg') }}">
                    <div class="card-body">
                        <h5 class="card-subtitle mb-2 text-muted text-center">Foto Perpustakaan</h5>
                    </div>
